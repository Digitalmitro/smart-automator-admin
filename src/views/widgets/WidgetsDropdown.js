...
const WidgetsDropdown = (props) => {
  ...
  const Getdata = async () => {
    try {
      ...
      setCoupon(resss.data) // get coupon data
      // setCallbackData(resss.data) // Update alluser length
      // setSaleData(ressss.data) // Update alluser length
      // setTransferData(resssss.data) // Update alluser length
    } catch (error) {
      // Handle errors here
  ...
  return (
    <CRow className={props.className} xs={{ gutter: 4 }}>
      ...
      <CCol
        ...
        xxl={3}
        style={{ cursor: 'pointer' }}
        onClick={() => navigate('/best-purchase-product')}
      >
        <CWidgetStatsA
          color="info"
          value={
      ...
      <CCol
        ...
        xxl={3}
        style={{ cursor: 'pointer' }}
        // onClick={() => navigate('/night_shift_attendance')}
      >
        <CWidgetStatsA
          color="info"
          value={
            <>
              ...
              <span className="fs-6 fw-normal">{/* (1.9% <CIcon icon={cilArrowTop} />) */}</span>
            </>
          }
          title="Stock Data"
          action={
      ...
      <CCol
        ...
        xxl={3}
        style={{ cursor: 'pointer' }}
        onClick={() => navigate('/view-coupon')}
      >
        <CWidgetStatsA
          color="danger"
          value={<> Coupon Usage Report: {coupon.length}</>}
          title="Coupon Usage"
          action={
            <CDropdown alignment="end">
              <CDropdownToggle color="transparent" caret={false} className=" p-0">
