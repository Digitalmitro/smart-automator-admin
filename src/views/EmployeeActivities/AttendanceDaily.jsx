...
const AttendaceDaily = () => {
 ...
 console.log(currentDate)
  ...
  const filteredNew= data3.filter(item => {
    // Assuming currentDate and item.currentDate are in the same format
    return item.currentDate === currentDate;
  });
  console.log(filteredNew)
  const groupedData = Object.values(
    filteredNew.reduce((acc, curr) => {
        ...
        <motion.div className=" main-container1 container  ">
          ...
          <div className="container margin-container ">
            <div className="d-flex" style={{ justifyContent: 'space-between' }}>
              <CCardHeader>
                <motion.h2 className=" fw-bold ms-3">Today's Attendace</motion.h2>
              </CCardHeader>
